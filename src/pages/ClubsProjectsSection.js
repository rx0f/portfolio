        ...
        <section>
            ...
            <div className="font-['Montserrat'] py-[4%] px-[8%]">
                ...
                <div className="flex mt-12 mb-8 flex-col items-center">
                    <h2 className="text-5xl font-bold">Clubs</h2>
                ...
                <div className="flex justify-evenly">
                    ...
                    <ClubCard name="School of AI Algiers" logo={SOAI} poste="Development department member" more="http://algierschoolofai.tech/"/>
                </div>
                <div className="flex mt-12 mb-8 flex-col items-center">
